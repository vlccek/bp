...
\projectinfo{
  ...
  title.cs={Akcelerace vyhledávání v prostorových \\
  strukturách},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Search Acceleration in Spatial Structures}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Vlk},   % příjmení autora / author surname 
...
% řeší první/posleento text slouží jako ukázkový obsah šablony a současně rekapituluje nejdůležitější informace z předpisů a poskytuje další užitečné informace, které budete potřebovat pro tvorbu technické zprávy ke svojí práci. Než se šablonou budete dále pracovat, je třeba vědět, jak ji správně použít. To je stručně uvedeno v~příloze \ref{jak}.
%===============================================================================dní řádek odstavce na předchozí/následující stránce
